package com.eip.security.oauth2;

import com.eip.config.oauth2.OAuth2Properties;
...
public class UaaSignatureVerifierClient implements OAuth2SignatureVerifierClient {
    ...
    public UaaSignatureVerifierClient(DiscoveryClient discoveryClient, @Qualifier(Constants.LOAD_BALANCED_REST_TEMPLATE) RestTemplate restTemplate,
    ...
    private String getPublicKeyEndpoint() {
        ...
        if (tokenEndpointUrl == null) {
            throw new InvalidClientException(Constants.NO_TOKEN_ENDPOINT_CONFIGURED_IN_APPLICATION_PROPOTIES);
        }
