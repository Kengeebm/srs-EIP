...
public class OAuth2Properties {
    ...
    public static class WebClientConfiguration {
        private String clientId = Constants.WEB_APP;
        private String secret = Constants.CHANGEIT;
        /**
    ...
    public static class SignatureVerification {
         ...
         */
        private String publicKeyEndpointUri =  Constants.TOKENKEY_URI;
