...
import com.eip.domain.PersistentAuditEvent;
        ...
        if (data != null) {
            for (Map.Entry<String, Object> entry : data.entrySet()) {
                ...
                if (entry.getValue() instanceof WebAuthenticationDetails) {
                    ...
                    results.put(Constants.REMOTE_ADDRESS, authenticationDetails.getRemoteAddress());
                    results.put(Constants.SESSION_ID, authenticationDetails.getSessionId());
                } else {
